    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('levelUser_softDelete') }}" type="button" class="btn btn-warning ml-auto">Lihat Soft Delete</a>
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->nama }}</td>
                            <td>
                                <form action="{{ route('levelUser.destroy', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <!-- Edit Button -->
                        ...
                        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('levelUser.update', $item->id) }}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label for="nama">Nama Level User</label>
