              ...
              <tbody>
                  ...
                  @foreach ($data as $item)
                      <tr>
                          ...
                          <td>{{ $item->nama }}</td>
                          <td>{{ $item->email }}</td>
                          <td>{{ isset($item->levelUser) ? $item->levelUser->nama : 'No Level User' }}
                          </td>
  ...
  <form action="{{ route('user.update', $item->id) }}" method="post">
      ...
      <div class="form-group">
          ...
          <select class="form-control" name="id_level_user">
              ...
              @foreach ($levelUser as $i)
                  <option value="{{ $i->id }}"
                      {{ $i->id == $item->id_level_user ? 'selected' : '' }}>
                      {{ $i->nama }}</option>
              @endforeach
          </select>
      </div>
      ...
      <div class="form-group">
          <label for="alamat">Alamat</label>
          <textarea name="alamat" class="form-control" id="alamat">{{ $item->alamat }}</textarea>
      </div>
      <div class="form-group">
          <label for="tanggal_lahir">Tanggal Lahir</label>
