...
<body>
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">Soft Deleted User</div>

                    <div class="card-body">
                        @if ($trash->isEmpty())
                            <p>No soft deleted User found.</p>
                        @else
                            @php $no = 1; @endphp
                                ...
                                <tbody>
                                    @foreach ($trash as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('user_restore', $item->id) }}" method="POST">
                                                    @csrf
                    ...
                    <div class="card-footer">
                        <a href="{{ route('user.index') }}" class="btn btn-primary">Kembali User</a>
                    </div>
                </div>
            </div>
        </div>
