...
class LevelUserController extends Controller
{
  ...
  public function forceDelete($id)
  {
    try {
      ...
      return redirect()->route('levelUser.softDelete')->with('success', 'Level user permanently deleted.');
    } catch (\Exception $e) {
      return redirect()->route('levelUser.softDelete')->with('error', 'Failed to permanently delete level user.');
    }
  }
}
