...
class TingkatStudiController extends Controller
{
  ...
  public function forceDelete($id)
  {
    try {
      ...
      return redirect()->route('tingkat_studi.softDelete')->with('success', 'Tingkat Studi permanently deleted.');
    } catch (\Exception $e) {
      return redirect()->route('tingkat_studi.softDelete')->with('error', 'Failed to permanently delete Tingkat Studi.');
    }
  }
}
