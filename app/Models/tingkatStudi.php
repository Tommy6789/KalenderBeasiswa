...
class tingkatStudi extends Model
{
  ...
  {
    return $this->belongsToMany(kalenderBeasiswa::class, 'ktingkat_studis', 'id_tingkat_studi', 'id_kbeasiswa')
      ->withPivot('deleted_at')
      ->withTimestamps()
      ->using(tingkatStudi::class); // Ensure using the correct pivot model
  }
