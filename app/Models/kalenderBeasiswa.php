...
class kalenderBeasiswa extends Model
{
  use HasFactory;
  use SoftDeletes;
  ...
  /**
   * Define the relationship with tingkatStudi (Study Level) model.
   *
   * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
   */
  public function tingkatStudi()
  {
    return $this->belongsToMany(tingkatStudi::class, 'ktingkat_studis', 'id_kbeasiswa', 'id_tingkat_studi')->withPivot('deleted_at')->withTimestamps();
  }
